    ...
    <div className="about">
      ...
      <div className="about-topic-cont">
        ...
        <div>
          <h1>About Us</h1>
          <p>
            <b>Welcome to PRYMUN</b>, where innovation drives our passion for
            redefining the future of mobility. At <b>PRYMUN</b> , we blend{" "}
      ...
      <div className="abt-main">
        ...
        <div className="abt-descrp">
          ...
          <p>
            PRYMUN cars redefine the driving experience with advanced electric
            propulsion, ensuring eco-friendly performance. Their sleek,
            aerodynamic design not only enhances fuel efficiency but also
            captivates with a modern aesthetic. The future unfolds with PRYMUN's
            smart connectivity suite, seamlessly weaving navigation,
            entertainment, and interaction. Elevate your drive with PRYMUN, where
