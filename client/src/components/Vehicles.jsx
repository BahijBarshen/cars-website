    ...
    <div className="vehicles">
      ...
      <img className="vh_bg1" src="back_n.png" alt="" />
        <div className="vh-topic-cont">
          <h1>Vehicles</h1>
          <p>Explore wide range of vehicles from PRYMUN</p>
          <img src="hr.svg" alt="" />
        </div>
        <div className="vh-main-cont">
          <div>
            ...
            <div className="vh-descrp-cont">
              <h1>PRYMUN vehicles</h1>
              <p>
                Explore PRYMUN's Vehicles Page for a curated collection of sleek
                sedans, SUVs, high-performance sports cars, eco-friendly
                electric/hybrid vehicles, family-friendly minivans, compact city
                cars, and powerful trucks. PRYMUN ensures you find the perfect
                ride for your lifestyle.
              </p>
              <ul>
                <li>
                  <b>Electric Propulsion:</b> PRYMUN cars feature advanced
                  electric propulsion for eco-friendly, high-performance
                  driving.
                </li>
                <li>
                  <b>Aerodynamic Design:</b> PRYMUN vehicles showcase a
                  fuel-efficient, aerodynamic design for a modern and visually
                  striking aesthetic.
                </li>
                <li>
                  <b>Connectivity Suite:</b> PRYMUN's futuristic connectivity
