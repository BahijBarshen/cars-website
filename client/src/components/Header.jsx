      ...
      <div className="container-fluid nav-cont">
        <div className="nav-child1">
          <Link className="navbar-brand" to="/">
            <img className="logo logo1 logoicon1" src="/iconweb.jpg" alt="PRYMUN" />
          </Link>
        </div>
        ...
        <div className="nav-child3">
          ...
          <div className="account-up">
            <i className="fa-regular fa-circle-user account"  onClick={toggleNav}></i>
            <i class="fa-solid fa-angle-up account"></i>
          </div>
        </div>
      </div>
    </nav>
